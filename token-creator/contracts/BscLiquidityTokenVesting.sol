 ...
 *
 * Supported by this BSC build:
 * - BNB Smart Chain Mainnet -> PancakeSwap V2
 *
...
contract AngryLiquidityTokenVesting {
    ...
    function _routerForChain()
        ...
        returns (address)
    {
        // BNB Smart Chain Mainnet - PancakeSwap V2 Router
        if (
            block.chainid == 56
        ) {
            return
        ...
        // BNB Smart Chain Testnet - PancakeSwap V2 Router
        if (
            block.chainid == 97
        ) {
            return
